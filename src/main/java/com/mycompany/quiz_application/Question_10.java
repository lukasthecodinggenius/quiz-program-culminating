...
public class Question_10 extends javax.swing.JFrame {
    ...
    public Question_10(int questionAnswered, int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Which property is used to change the font size of text in CSS?");

        btnGroup1.add(jbtn1);
        jbtn1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jbtn1.setForeground(new java.awt.Color(0, 0, 0));
        jbtn1.setText("font-size");
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if(jbtn1.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect - Answer is font-size");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            quizanswered += 1;
            new Question_11(quizanswered, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question_10(0,0).setVisible(true);
            }
        });
    }
