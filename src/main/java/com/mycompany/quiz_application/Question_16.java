...
public class Question_16 extends javax.swing.JFrame {

     int quizanswered = 0;
    int marks = 0;
    
    public Question_16(int questionAnswered, int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Sitka Text", 3, 41)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Programming Language Trivia!");
        ...
        jLabel2.setText("Question 16");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 2, 22)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("What does the 'not' Operator do in Python?");

        btnGroup1.add(jbtn1);
        jbtn1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jbtn1.setForeground(new java.awt.Color(0, 0, 0));
        jbtn1.setText("Adds two numbers");
        ...
        jbtn3.setForeground(new java.awt.Color(0, 0, 0));
        jbtn3.setText("Checks if two values are equal");

        btnGroup1.add(jbtn2);
        jbtn2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jbtn2.setForeground(new java.awt.Color(0, 0, 0));
        jbtn2.setText("Negates a boolean value");
        ...
        jbtn4.setForeground(new java.awt.Color(0, 0, 0));
        jbtn4.setText("Converts a value to lowercase");

        btnCheckAnswer.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnCheckAnswer.setText("Check Answer");
        btnCheckAnswer.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 0, 51), 3, true));
        ...
        lblAnswerStatus.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(lblAnswerStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 774, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        btnSubmit.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 0, 0), 3, true));
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        //checks if the user has selected an option. Otherwise error message will be shown
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            JOptionPane.showMessageDialog(null, "Please Select an Answer");
        } else {
            //Code for when the user selects the right answer
            if(jbtn2.isSelected()) {
                lblAnswerStatus.setText("Correct");
                lblAnswerStatus.setForeground(Color.green);
            } else {
                lblAnswerStatus.setText("Incorrect - Answer is Negates a boolean value");
                lblAnswerStatus.setForeground(Color.red);
            }
            //Locking the buttons once 'check' is pressed
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if (jbtn2.isSelected()) {
                //assign 2 marks to the 'marks' variable
                marks += 2;
            } 
            quizanswered += 1;
            new Question_17(quizanswered, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Question_16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question_16(0,0).setVisible(true);
            }
        });
    }
