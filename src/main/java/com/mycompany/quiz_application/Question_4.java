...
public class Question_4 extends javax.swing.JFrame {
   ...
   int quizanswered = 0;
    ...
    public Question_4(int questionAnswered, int marks) {
        initComponents();
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if(jbtn2.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect - Answer is Integrated Development Environment");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            quizanswered += 1;
            new Question_5(quizanswered, marks).setVisible(true);
            this.dispose();
                    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question_4(0,0).setVisible(true);
            }
        });
    }
