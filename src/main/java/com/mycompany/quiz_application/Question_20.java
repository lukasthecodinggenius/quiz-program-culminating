...
public class Question_20 extends javax.swing.JFrame {

   int quizanswered = 0;
    int marks = 0;
    public Question_20(int questionAnswered, int marks) {
        initComponents();
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if(jbtn1.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect - WOW");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Question_20.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question_20(0,0).setVisible(true);
            }
        });
    }
