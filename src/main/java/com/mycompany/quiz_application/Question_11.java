...
public class Question_11 extends javax.swing.JFrame {

    int quizanswered = 0;
    int marks = 0;
    
    public Question_11(int questionAnswered, int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Question 11");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 2, 22)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Which is the correct way to make a comment in Python?");
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if(jbtn2.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect - Answer is #");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            quizanswered += 1;
            new Question_12(quizanswered, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Question_11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question_11(0,0).setVisible(true);
            }
        });
    }
