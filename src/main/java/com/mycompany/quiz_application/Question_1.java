...
public class Question_1 extends javax.swing.JFrame {
  ...
  //this code will create a global variable for quiz answers and total marks
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if(jbtn2.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect - Answer is my_variable");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        //prevents user from going to the next question without selecting an answer
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            JOptionPane.showMessageDialog(null, "Please Select an Answer");
        } else {
            ...
            quizanswered += 1;
            new Question_2(quizanswered, marks).setVisible(true);
            this.dispose();
                    }
