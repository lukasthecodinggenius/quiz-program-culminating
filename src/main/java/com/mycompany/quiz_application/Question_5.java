...
public class Question_5 extends javax.swing.JFrame {
    ...
    public Question_5(int questionAnswered, int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("What is the syntax to declare a constant variable in c#?");

        btnGroup1.add(jbtn1);
        jbtn1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jbtn1.setForeground(new java.awt.Color(0, 0, 0));
        jbtn1.setText("final int x = 5");
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            if(jbtn4.isSelected()) {
                ...
                lblAnswerStatus.setText("Incorrect - Answer is const int x = 5");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jbtn1.isSelected() && !jbtn2.isSelected() && !jbtn3.isSelected() && !jbtn4.isSelected()) {
            ...
            quizanswered += 1;
            new Question_6(quizanswered, marks).setVisible(true);
            this.dispose();
                    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Question_5(0,0).setVisible(true);
            }
        });
    }
